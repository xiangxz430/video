...
export declare function enrichEachShot(shots: Shot[], episodeContent: string, characterInfo: string, sceneInfo: string, config: ApiConfig, onProgress?: StoryboardProgressCallback, onContentStream?: (content: string) => void, startIndex?: number, endIndex?: number, existingUsedContents?: string[], throwOnFail?: boolean): Promise<{
    enrichedShots: Shot[];
    usedContents: string[];
}>;
