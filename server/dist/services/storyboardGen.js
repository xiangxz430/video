...
// ========== 去重检测与修复 ==========
export async function deduplicateShots(shots, config, episodeContent, onContentStream) {
...
// ========== 辅助函数 1: 简单镜头结构划分 ==========
export async function splitShotsSimple(episodeContent, characterInfo, sceneInfo, config, onContentStream) {
